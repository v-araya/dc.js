...
* [ScatterPlot](#ScatterPlot)
    ...
    * [.opacityAccessor([opacityAccessor])](#ScatterPlot+opacityAccessor) ⇒ <code>function</code> \| [<code>ScatterPlot</code>](#ScatterPlot)
    * [.opacity([opacity])](#ScatterPlot+opacity) ⇒ <code>function</code> \| [<code>ScatterPlot</code>](#ScatterPlot)
...
### scatterPlot.opacityAccessor([opacityAccessor]) ⇒ <code>function</code> \| [<code>ScatterPlot</code>](#ScatterPlot)
...
| Param | Type |
| --- | --- |
| [opacityAccessor] | <code>function</code> | 

<a name="ScatterPlot+opacity"></a>

### scatterPlot.opacity([opacity]) ⇒ <code>function</code> \| [<code>ScatterPlot</code>](#ScatterPlot)
Set or get radius for symbols.
